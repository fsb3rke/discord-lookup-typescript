...
client.on("ready", () => {
    ...
    app.get("/api/users/:id", (req, res) => {
        ...
        client.users.fetch(req.params.id).then(user => {
            ...
            if (m_user.bannerUrl == "undefined") {
              m_user.bannerUrl = "https://avatars.githubusercontent.com/u/69055194?v=4"
            }
            if (m_user.avatarUrl == "undefined") {
              m_user.avatarUrl = "https://avatars.githubusercontent.com/u/69055194?v=4"
            }
